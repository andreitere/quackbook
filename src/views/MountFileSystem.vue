      ...
      <div class="prose prose-slate dark:prose-invert max-w-[1028px]">
        ...
        <div class="flex flex-col space-y-6">
          <div class="bg-slate-50 dark:bg-slate-800 p-6 rounded-lg">
            <h3 class="text-2xl font-bold text-primary-600 dark:text-primary-400">1. Running DuckDB Locally</h3>
            <p class="mt-2">
              This approach uses DuckDB's <a href="https://duckdb.org/community_extensions/extensions/httpserver.html" class="text-primary-600 dark:text-primary-400 hover:underline">httpserver extension</a> to run DuckDB directly on your machine, 
            ...
            <div class="mt-4">
              ...
              <p>Install the DuckDB CLI from the <a href="https://duckdb.org/docs/installation" class="text-primary-600 dark:text-primary-400 hover:underline">official documentation</a></p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div class="bg-white dark:bg-slate-700 p-4 rounded-lg">
                <h5 class="font-semibold text-primary-600 dark:text-primary-400">Benefits</h5>
              ...
              <div class="bg-white dark:bg-slate-700 p-4 rounded-lg">
                <h5 class="font-semibold text-primary-600 dark:text-primary-400">Considerations</h5>
                <ul class="list-disc pl-4 mt-2 space-y-1">
          ...
          <div class="bg-slate-50 dark:bg-slate-800 p-6 rounded-lg">
            <h3 class="text-2xl font-bold text-primary-600 dark:text-primary-400">2. HTTP Server Access</h3>
            <p class="mt-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div class="bg-white dark:bg-slate-700 p-4 rounded-lg">
                <h4 class="font-semibold text-lg text-primary-600 dark:text-primary-400">Node.js Method</h4>
                <div class="mt-2 space-y-2">
                  <div class="bg-slate-100 dark:bg-slate-600 p-2 rounded">
                    <code class="text-sm font-mono">npx serve --cors</code>
                  </div>
                  <p class="text-sm text-slate-600 dark:text-slate-300">or</p>
                  <div class="bg-slate-100 dark:bg-slate-600 p-2 rounded">
              ...
              <div class="bg-white dark:bg-slate-700 p-4 rounded-lg">
                <h4 class="font-semibold text-lg text-primary-600 dark:text-primary-400">Python Method</h4>
                <div class="mt-2">
                  <div class="bg-slate-100 dark:bg-slate-600 p-2 rounded">
