      ...
      <div class="tree-item">
        ...
        <CollapsibleContent>
          <div class="tree-children">
            <div
              v-for="(schema, schemaName) in database.schemas"
              :key="schemaName"
              class="tree-item"
            >
              <Collapsible
                v-model:open="schemaExpandedStates[schemaName]"
                class=""
              >
                <CollapsibleTrigger class="tree-header w-full">
                  <div class="flex items-center gap-2">
                    <div class="tree-icon">
                      <div class="i-tabler:folder" />
                    </div>
                    <div class="tree-content">
                ...
                <CollapsibleContent>
                  <div class="tree-children">
                    <div
                      v-for="(table, tableName) in schema.tables"
                      :key="tableName"
                      class="tree-item"
                    >
                      <Collapsible
                          ...
                          <div class="tree-children">
                            ...
                            >
                              <div class="tree-header">
                                <div class="flex items-center gap-2">
                                  <div class="tree-icon">
                                    <div class="i-tabler:column-insert-right" />
                                  </div>
                                  <div class="tree-content">
...
.tree-header {
	@apply flex items-center gap-1.5 py-0.5 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded;
}

.tree-icon {
	@apply flex items-center justify-center w-3.5 h-3.5 text-gray-500 dark:text-gray-400;
}

.tree-content {
	@apply flex items-center gap-1.5 text-gray-900 dark:text-gray-100;
}
